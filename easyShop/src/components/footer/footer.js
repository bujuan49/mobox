        ...
        return (
            <div className='foot_wrap'>
                <ul>
                    ...
                    <li> <span className='iconfont icon-xiazai'></span><NavLink to='/special'>专题</NavLink></li>
                    <li> <span className='iconfont icon-fenxiang'></span><NavLink to='/classify'>分类</NavLink></li>
                    <li> <span className='iconfont icon-iconset0124'></span><NavLink to='/shopcar'>购物车</NavLink></li>
